...
# ============================================================================ #
# Создание ВМ для учебных GitLab раннеров (ubuntu-server 22.04)                #
# ============================================================================ #

VM_NAME="GitLab-Runners"
RAM="4096"
VCPUS="4"
DISK_SIZE="40"
...
virt-install \
  ...
  --disk path="/var/lib/libvirt/images/${VM_NAME}-docker.qcow2",size=20,format=qcow2,bus=virtio \
  ...
  --boot uefi \
  --description "GitLab Runner (Ubuntu 22.04)"
